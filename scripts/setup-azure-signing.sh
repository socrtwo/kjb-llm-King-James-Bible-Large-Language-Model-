...
readonly GITHUB_REPO="kjb-llm-King-James-Bible-Large-Language-Model-"
...
add_federated_cred \
  "gh-kjb-llm-King-James-Bible-Large-Language-Model--release-env" \
  "repo:$GITHUB_OWNER/$GITHUB_REPO:environment:release"

add_federated_cred \
  "gh-kjb-llm-King-James-Bible-Large-Language-Model--main-branch" \
